		            ...
		            <div class="wizard-container">
		                ...
		                <div class="card wizard-card" data-color="orange" id="wizardProfile">
							<div class="wizard-header text-center mt-3" style="margin-bottom: 40px;">
								<h1 class="">DBS</h1>
								<h3 class="mt-2">Do you have DBS link?</h3>
							</div>
							<div class="row">
							    <div class="col-sm-6 text-center">
                                                                <a href="<?= base_url('portal/dbs/yes')?>" class="btn btn-success">Yes</a>
							    </div>
							    <div class="col-sm-6 text-center">
							        <a href="<?=base_url('portal/dbs/no')?>" class="btn btn-danger">No</a>
							    </div>
							</div>
		                </div>
